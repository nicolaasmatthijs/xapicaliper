 ...
 * @param  {Object}         [opts.CALIPER.target]             The properties that describe the Caliper target of the learning activity
...
Caliper.generateStatement = function(config, statement, opts) {
  ...
  // Add the learning activity target when one has been provided
  if (opts.CALIPER.target) {
    generatedStatement.generated = opts.CALIPER.target;
  }
