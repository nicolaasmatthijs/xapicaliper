...
XAPI.generateStatement = function(config, statement, opts) {
  ...
  var generatedTimestamp = XAPI.generateDate(statement.timestamp);
 ...
 *
 * @param  {Date}           date                              Date for which to generate an xAPI compatible date string
 * @return {String}                                           The date string in an xAPI compatible format. `null` if invalid input has been provided
 */
