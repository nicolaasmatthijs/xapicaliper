 ...
 * @param  {String}         statement.metadata.id             The URL of the session generated by logging in
  ...
  StatementUtil.processStatement(config, statement, {
    ...
    'CALIPER': {
      ...
      'generated': StatementUtil.Caliper.generateEntity({
        'type': CaliperEntityType.SESSION,
        'id': statement.metadata.id,
        'startedAtTime': StatementUtil.generateDate(statement.timestamp),
...
var navigateToCourse = module.exports.navigateToCourse = function (config, statement, callback) {
  ...
  StatementUtil.processStatement(config, statement, {
    ...
    'CALIPER': {
      'type': CaliperEventType.NAVIGATION,
